...
- **Microservices & distributed systems** — event-driven services in Go, Kotlin, and Python.
- **Performance & scale** — optimizing latency and throughput on high-volume systems.
- **Reliability & observability** — instrumenting services with Datadog, metrics, and tracing.
- **From hardware to cloud** — embedded C background, now full-time on backend & infra.
...
<sub>Electronic Engineer at heart — ask me about Raspberry Pi, Arduino, or embedded C. 🤖</sub>
